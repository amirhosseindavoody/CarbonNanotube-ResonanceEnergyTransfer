...
main.o: cnt_class.o comparams.o input_cnt_mod.o occupation_mod.o parse_input_file_mod.o prepareForster_module.o target_exciton_mod.o transition_table_mod.o write_log_mod.o
