...
free_electron_mod.o: cnt_class.o write_log_mod.o
...
main.o: cnt_class.o comparams.o free_electron_mod.o input_cnt_mod.o occupation_mod.o parse_input_file_mod.o prepareForster_module.o transition_table_mod.o write_log_mod.o
