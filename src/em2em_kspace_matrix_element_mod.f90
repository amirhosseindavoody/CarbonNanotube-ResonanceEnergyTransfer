module em2em_kspace_matrix_element_mod
	implicit none
	private
    public  :: calculate_em2em_kSpaceMatrixElement
...
contains
	...
	subroutine calculate_em2em_kSpaceMatrixElement(nTransitionPoints, transitionPoints, kSpaceMatrixElement)
		...
		do iT = 1,nTransitionPoints
			...
			do ikr1 = cnt1%ikr_low, cnt1%ikr_high
				...
				do ikr2 = cnt2%ikr_low, cnt2%ikr_high
					...
					do is = 1,2
						do isp = 1,2
							tmpc1 = conjg(cnt1%Cc(2,ikc1,is))*cnt1%Cv(1,ikv1,is)*cnt2%Cc(2,ikc2,isp)*conjg(cnt2%Cv(1,ikv2,isp))
		...
		return		
	end subroutine calculate_em2em_kSpaceMatrixElement

				
end module em2em_kspace_matrix_element_mod