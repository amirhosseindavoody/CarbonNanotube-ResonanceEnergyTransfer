module ep2em_matrix_element_mod
	implicit none
	private
    public  :: calculate_ep2em_kSpaceMatrixElement, calculate_ep2em_finitegeometricMatrixElement, calculate_ep2em_infiniteGeometricMatrixElement_unparallel
...
contains
	...
	subroutine calculate_ep2em_kSpaceMatrixElement(kSpaceMatrixElement)
		...
		do iC = 1,nSameEnergy
			...
			do ikr1 = cnt1%ikr_low, cnt1%ikr_high
				...
				do ikr2 = cnt2%ikr_low, cnt2%ikr_high
					...
					do is = 1,2
						do isp = 1,2
							tmpc1 = conjg(cnt1%Cc(1,ikc1,is))*cnt1%Cv(2,ikv1,is)*cnt2%Cc(2,ikc2,isp)*conjg(cnt2%Cv(1,ikv2,isp))
		...
		return		
	end subroutine calculate_ep2em_kSpaceMatrixElement

	!**************************************************************************************************************************
	! calculate the geometric part of matrix element for two finite tubes forming angle theta
	!**************************************************************************************************************************
	
	subroutine calculate_ep2em_finiteGeometricMatrixElement(iKcm1, iKcm2, theta, c2cDistance, geometricMatrixElement)
		use comparams, only: cnt1, cnt2
		...
		return
	end subroutine calculate_ep2em_finiteGeometricMatrixElement
	...
	subroutine calculate_ep2em_infiniteGeometricMatrixElement_unparallel(iKcm1, iKcm2, theta, c2cDistance, geometricMatrixElement)
		use comparams, only: cnt1, cnt2
		...
		return		
	end subroutine calculate_ep2em_infiniteGeometricMatrixElement_unparallel

				
end module ep2em_matrix_element_mod